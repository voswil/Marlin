...
// Ultimaker
    #define  DEFAULT_Kp 11.19//22.2
    #define  DEFAULT_Ki 0.37//1.08
    #define  DEFAULT_Kd 85.62//114
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 1.00
    #define  DEFAULT_bedKi .0023
    #define  DEFAULT_bedKd 1305.4
...
#define DELTA_EE_OFFS    18.35+11.54-23.88-0.5+1.5+0.4+6.5-2.2//15.0  // Ball joint plane to bottom of end effector surface.  
...
//#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
      ...
      #define XY_TRAVEL_SPEED 800//8000         // X and Y axis travel speed between probes, in mm/min
...
#define DEFAULT_ACCELERATION          4000 //all divided by ten by me  //10000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  4000 //all divided by ten by me     // X, Y, Z and E max acceleration in mm/s^2 for retracts
